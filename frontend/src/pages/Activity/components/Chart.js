...
class Chart extends React.Component {
    ...
    render() {
        ...
        const start_time = this.props.data[0].timestamp
        const data = {
            name: "Data",
            columns: ["time", "value"],
            points: this.props.data.map(record => {
                var pts = new Array();
                pts[0] = (record.timestamp - start_time) * 1000;
                pts[1] = UnitConversion.instance().convertSpeedToPace(record.speed);
                return pts
            })
        }
                    ...
                    >
                        <ChartRow height="200">
                            <YAxis 
                                ...
                                width="60"
                                format={elt => {
                                    const min = Math.floor(elt);
                                    const sec = (min - elt) * 60;
...
//         points: this.props.data.map(record => {
//             var pts = new Array();
//             pts[0] = record.timestamp - start_time;
//             pts[1] = record.speed;
//             return pts
//         })
//         // points: [
...
//     // console.log(data.widget[0].data.reverse())
